...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const sessionParams: Stripe.Checkout.SessionCreateParams = {
      ...
      mode: mode,
              success_url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://beta.taptify.com'}/payment-success?session_id={CHECKOUT_SESSION_ID}&package_id=${packageId}&credits=${packageData.credit_count}`,
