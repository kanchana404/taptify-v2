// components/promptmanagetab/inbound/InboundTaskPrompt.tsx
"use client";
import PromptField from "../PromptField";

interface InboundTaskPromptProps {
  value: string;
...
const InboundTaskPrompt: React.FC<InboundTaskPromptProps> = ({
  value,
  onChange,
  clientName = "",
  companyName = ""
...
export default InboundTaskPrompt;